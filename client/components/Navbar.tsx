...
export function Navbar({ roomId }: NavbarProps) {
  ...
  return (
    <>
      ...
      <nav className="absolute left-80 right-0 h-16 z-50 bg-gradient-to-r from-gray-950 to-gray-800 bg-opacity-50 backdrop-blur-md border-b border-gray-800 flex items-center justify-between px-4">
