        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="pt-3">
              You will need to pay royalties on any profits generated by this workflow. The royalties will be distributed to the creators of the{" "}
      ...
      <Dialog open={showStopDialog} onOpenChange={setShowStopDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="pt-3">
              10% of your earnings will be distributed as royalties to the creators of the blocks used in this workflow.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="flex justify-end gap-2 pt-4">
